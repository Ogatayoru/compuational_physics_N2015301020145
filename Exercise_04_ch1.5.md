...
- Now we assume that the two types of decay are characterized by the same time contant, τ, with ![](http://latex.codecogs.com/gif.latex?N_A$) and ![](http://latex.codecogs.com/gif.latex?N_B$) represent the numbers of nuclei, as functions of time.
